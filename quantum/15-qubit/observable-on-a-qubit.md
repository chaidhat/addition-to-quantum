...
Any [[observable|observable]] on a [[qubit]] can be written as
...
This is known as the "spin along the unit [[vector|vector]] $\hat{n}$".
...
We work out the [[eigenvectoreigenvalue|eigenvalues]] by doing
