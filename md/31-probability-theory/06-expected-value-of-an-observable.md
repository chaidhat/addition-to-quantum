...
To determine the mean (EV) of an [<span class="underline">operator</span>](#operators) $\hat{A}$, we must know the state $\left\lvert \psi \right\rangle$ you’re in.
$$\begin{gather*}
...
where $tr$ is [<span class="underline">trace</span>](#traces)
