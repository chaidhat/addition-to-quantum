...
$$
\begin{gather*}
    P_{\psi_n}=|\left\langle \psi_n|\psi \right\rangle|^2
\end{gather*}
$$
...
BE CAREFUL 
$\ket{\psi_n}$ is an [[ket-state|STATE VECTOR]], $\psi_n$ is a probability amplitude which is a [[complex-number|COMPLEX NUMBER]]. Notation is really confusing in QM.