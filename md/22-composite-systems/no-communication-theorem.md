...
If Alice measures in z basis, Bob’s conditional state is $\left\lvert 0 \right\rangle$ or $\left\lvert 1 \right\rangle$ with 50/50 [[probability-theory|probability]]. If Alice measures in x basis, Bob’s conditional state is $\left\lvert + \right\rangle$ or $\left\lvert - \right\rangle$ with 50/50 probability.
