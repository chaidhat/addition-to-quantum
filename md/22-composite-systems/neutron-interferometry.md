...
This is how you rotate a [[ket-state|quantum state]] by an angle $\theta$ around $\hat{n}$ where $\hat{J}_{\hat{n}}$ is the [[angular-frequency|angular momentum]] operator along $\hat{n}$.
