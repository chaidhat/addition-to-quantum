...
A [[ket-states|state]] $\ket{\psi}\in H$ of a [[spin-12-systems||quantum particles]] is a [[vectors|vector]] in [[complex-numbers|complex]] [[hilbert-spaces||Hilbert space]]. 
...
$$
Measurement probability: Born's rule
$$
Pr(n)=|\psi_n|^2
$$
