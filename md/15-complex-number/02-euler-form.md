...
Euler, another person, said that since [<span class="underline">Taylor series</span>](#taylor-series) is a thing, we can say that
...
This means we can represent [<span class="underline">complex numbers</span>](#complex-numbers) in this weird form too:
