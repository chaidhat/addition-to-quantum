...
Recall from [<span class="underline">particle energies</span>](#particle-energies) that

$$\begin{gather*}
    \left\lvert \psi(0) \right\rangle=\sum_kc_k\left\lvert E_k \right\rangle
\end{gather*}$$

Because we learned this thing called [<span class="underline">particle phases</span>](#particle-phases), we can say that particle
...
Let the Hamiltonian $H$be an [<span class="underline">operator</span>](#operators) where this is true
