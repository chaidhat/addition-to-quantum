...
Recall all the way back to what a [<span class="underline">quantum state</span>](#ket-states) is.

A composite quantum state is a state that lives in a [<span class="underline">composite system</span>](#composite-system).
Recall [<span class="underline">tensor product</span>](#tensor-product) of two Hilbert spaces $H_A$ and $H_B$.
