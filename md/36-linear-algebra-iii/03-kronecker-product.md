...
The Kronecker product is a way to compute the [<span class="underline">tensor product</span>](#tensor-product) of two matrices. It outputs a matrix as well.
...
Let $\left\lvert 0 \right\rangle, \left\lvert 1 \right\rangle$ be a rank-1 tensor, i.e., a vector. Recall from [<span class="underline">ket states</span>](#ket-states) and [<span class="underline">quantum systems</span>](#quantum-system) that it is defined as
