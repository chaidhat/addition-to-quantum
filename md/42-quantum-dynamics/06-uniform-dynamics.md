...
Recall [<span class="underline">matrix exponential</span>](#matrix-exponentials):
...
via [<span class="underline">Baker Campbell Hausdorff Formula</span>](#baker-campbell-hausdorff-formula), since $[H,H]=0$ (trivially as any operator commutes with itself)
