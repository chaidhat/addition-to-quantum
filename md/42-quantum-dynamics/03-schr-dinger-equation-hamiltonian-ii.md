...
Let’s derive the Schrödinger equation from the postulates of an [<span class="underline">isolated system</span>](#isolated-system).
...
1.  $\Lambda(t, t_0)$ is [<span class="underline">anti-Hermitian</span>](#anti-hermitian-operators).
