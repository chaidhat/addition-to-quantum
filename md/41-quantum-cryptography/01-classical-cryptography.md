...
Let ciphertext $C$, plaintext $P$, and key $K$ be [<span class="underline">strings</span>](#strings) of bits $\{0,1\}^*$.
Let $E$ be an encryption [<span class="underline">function</span>](#functions) and $D$ be a decryption [<span class="underline">function</span>](#functions).
